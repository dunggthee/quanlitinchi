...
<div align="center">
   <table align="center" width="100%" style=" border: 1px;border-color:black;  width: 1300px;">
    <tbody>
  ...
  $kq=mysqli_query($conn,$sql);
                ...
                while ($row=mysqli_fetch_array($kq)) {
                    ...
                    echo "<tr style='background: #ffd4aa; height: 30px; vertical-align: middle;'>";
                        ...
                        echo "<td align='center'><a onClick=\"javascript: return confirm('Xác Nhận Xóa !');\" href='../Controller/delete_dsdangky.php?mamonhoc=".$mamonhoc."'><img align='center' src='../img/delete.gif'></a></td>";
                    echo "</tr>";   
                    # code...
                }
       ?>
