...
<?php
                ...
                while ($row=mysqli_fetch_array($kq)) {
                    ...
                    echo "<tr style='background: #ffd4aa; height: 30px; vertical-align: middle;'>";
                        ...
                        echo "<td align='center'><a onClick=\"javascript: return confirm('Xác Nhận Xóa !');\" href='../Controller/delete_monhoc.php?mamonhoc=".$mamonhoc."'><img align='center' src='../img/delete.gif'></a></td>";
